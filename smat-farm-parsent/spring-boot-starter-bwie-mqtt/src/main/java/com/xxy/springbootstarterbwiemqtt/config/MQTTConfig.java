package com.xxy.springbootstarterbwiemqtt.config;

import com.wlz.springbootstarterbwiemqtt.annotayion.MqttListener;
import com.wlz.springbootstarterbwiemqtt.consumer.MqttMessageHandlerDev;
import com.wlz.springbootstarterbwiemqtt.consumer.SubscribeTopicsManager;
import com.wlz.springbootstarterbwiemqtt.context.SpringApplicationContextUtils;
...
public class MQTTConfig {
    ...
    private void handlerAnnotation(String topic,String payload){
        Reflections reflections = new Reflections(
                new ConfigurationBuilder().forPackages("com.wlz").addScanners(
